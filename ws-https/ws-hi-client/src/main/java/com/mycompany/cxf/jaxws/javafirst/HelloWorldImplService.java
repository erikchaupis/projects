 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://javafirst.jaxws.cxf.mycompany.com/", wsdlLocation = "http://10.50.24.115:9090/cxf-jaxws-javafirst/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://javafirst.jaxws.cxf.mycompany.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.50.24.115:9090/cxf-jaxws-javafirst/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://javafirst.jaxws.cxf.mycompany.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javafirst.jaxws.cxf.mycompany.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
